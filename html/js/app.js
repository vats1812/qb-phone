...
QB.Phone.Functions.SetupApplications = function(data) {
    ...
    $.each(data.applications, function(i, app) {
        ...
        if ((!app.job || app.job === QB.Phone.Data.PlayerJob.name) && !blockedapp) {
            ...
            var icon = '<img class="ApplicationIcon" src="./img/' + app.icon + '.png" style="' + app.style + '">';
            if (app.app == "meos") {
                icon = '<img src="./img/politie.png" class="police-icon" style="background-color: steelblue; border-radius: 10px; height: 4.7vh; width: 4.7vh;">';
            }
