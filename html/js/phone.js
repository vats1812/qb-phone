...
QB.Phone.Functions.LoadContacts = function(myContacts) {
    ...
    if (myContacts !== null) {
        $.each(myContacts, function(i, contact) {
            ...
            var ContactElement = '<div class="phone-contact" data-contactid="' + i + '"><div class="phone-contact-firstletter" style="background-color: #e74c3c; color: var(--ttl-text);">' + ((contact.name).charAt(0)).toUpperCase() + '</div><div class="phone-contact-name">' + contact.name + '</div><div class="phone-contact-actions"><img class="down" id="arr-img" src="https://cdn-icons-png.flaticon.com/512/2223/2223660.png"></div><div class="phone-contact-action-buttons"> <img id="phone-start-call" src="https://cdn-icons-png.flaticon.com/512/2038/2038762.png"><img id="new-chat-phone" src="https://cdn-icons-png.flaticon.com/512/255/255334.png"><img src="https://cdn-icons-png.flaticon.com/512/5455/5455936.png" id="edit-contact"></div></div>'
            if (contact.status) {
                ContactElement = '<div class="phone-contact" data-contactid="' + i + '"><div class="phone-contact-firstletter" style="background-color: #2ecc71;">' + ((contact.name).charAt(0)).toUpperCase() + '</div><div class="phone-contact-name">' + contact.name + '</div><div class="phone-contact-actions"><img class="down" id="arr-img" src="https://cdn-icons-png.flaticon.com/512/2223/2223660.png"></div><div class="phone-contact-action-buttons"> <img id="phone-start-call" src="https://cdn-icons-png.flaticon.com/512/2038/2038762.png"><img id="new-chat-phone" src="https://cdn-icons-png.flaticon.com/512/255/255334.png"><img src="https://cdn-icons-png.flaticon.com/512/5455/5455936.png" id="edit-contact"></div></div>'
            }
...
$(document).on('click', '.phone-contact-actions', function() {
    var dwn = $('#arr-img').hasClass("down");
    if (dwn == true) {
        $('#arr-img').addClass("up");
        $('#arr-img').removeClass("down");
    }
    if (dwn == false) {
        $('#arr-img').addClass("down");
        $('#arr-img').removeClass("up");
    }
})
...
QB.Phone.Functions.SetupSuggestedContacts = function(Suggested) {
    ...
    if (AmountOfSuggestions > 0) {
        ...
        $.each(Suggested, function(index, suggest) {
            var elem = '<div class="suggested-contact" id="suggest-' + index + '"> <img src="https://cdn-icons-png.flaticon.com/512/2227/2227872.png" alt="suggest"> <span class="suggested-name">' + suggest.name[0] + ' ' + suggest.name[1] + ' &middot; <span class="suggested-number">' + suggest.number + '</span></span> </div>';
